...
**核對範例**：台積電(2330.TW)→欣銓(3264.TWO)這組本研究引用最多次的核心關係，split_sample_granger.csv裡F1=10.282、F2=10.662，兩段皆通過FDR，分類「全期間穩定」——已比對確認與原始packaging-network-study/版本一致（差異僅在小數點第7-8位）。
